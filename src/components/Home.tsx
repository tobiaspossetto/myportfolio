...
const Home = ():JSX.Element => {
    return (
        <Flex  pt='80px' direction={{base:"column", sm: "column", md: "column", lg: "row"}} align="center"  justify="space-around" pr='10px' pl='10px'>
            <Stack mt='35px' spacing={0}>
                ...
                <Box  display='flex' alignItems='center' justifyContent='center' width='100%'>
                         <Button  fontSize={{base: "16px", sm:'22px', md:'24px', lg:'24px'}}  padding={{base: "8px", sm:'8px', md:'20px', lg:'20px'}} width={{ base: "60%", sm: "65%", md: "40%", lg: "40%" }} variant='cta'>Download CV</Button>
                </Box>
